...
temperature.prototype.run = function() {
  ...
  container_temp.append('<div class="box box-w-200 box-h-100 bg-dark" id="outside_overview"><div class="content box-w-120 box-h-100"><div id="indicator_311" class="icon-temp-indicator">&nbsp;</div><h4>Ute</h4><h1 class="fg-light"><span id="311"></span>&deg;C</h1></div><div class="content box-w-80 box-h-100 right"><h5 class="fg-light-red"><span id="max_311"></span>&deg;C</h5><h5 class="fg-light-blue"><span id="min_311"></span>&deg;C</h5><h5 class="fg-light"><span id="312"></span>%RH</h5></div></div></div>');
