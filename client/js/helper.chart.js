	...
	if (curGrapho !== undefined) {
		...
		currentGraph[dest] = curGrapho.addDataSet({
				...
				y: { 
					...
					scaleStyle: color,
					gridStyle: '#121212',
					labelStyle: (dest === 'eliq_chart_dataday') ?  '#DD9966' : color,
					nameStyle: (dest === 'eliq_chart_dataday') ?  '#DD9966' : color,
		...
		console && console.error && console.error ('Trying to add data to a non-eisting grapho.');
	}
}
